...
# ─── Relay Profiles ───────────────────────────────────────────────────────────
# ✅ CHANGE 1 : Nouveau dictionnaire avec sites majeurs à {} (utilisation des stratégies intégrées)
RELAY_PROFILES = {
    # Sites avec sélecteurs personnalisés (testés et fiables)
    "recolyse.com": {
        "username_selector": [
            "#outlined-basic",
            "input[type='email']",
    ...
    # Sites majeurs : {} = pas de sélecteurs explicites
    # → playwright_relay.py utilisera _SITE_STRATEGIES
    "pinterest.com": {},
    "linkedin.com": {},
    "facebook.com": {},
    "instagram.com": {},
...
async def relay_login(
    ...
    # ✅ CHANGE 2 : lookup du profil avec support des sous-domaines www.
    _bare = domain.lstrip("www.")
    relay_profile = RELAY_PROFILES.get(_bare, RELAY_PROFILES.get(domain, {}))
    ...
    # ✅ CHANGE 3 : timeout passé à 120 secondes (déjà en place, maintenu)
    try:
...
#     # Sites majeurs – on laisse le dictionnaire vide pour que les stratégies intégrées
#     # (détection automatique + sélecteurs par défaut) prennent le relais.
#     # Vous pouvez ajouter des sélecteurs spécifiques si nécessaire.
#     "linkedin.com": {},
#     "facebook.com": {},
#     "github.com": {},
#     "twitter.com": {},
...
# # Optionnel : normalisation du domaine dans la route relay_login
# # (déjà fait avec .lstrip("www.") – vous pouvez garder la ligne existante)
...
#     relay_profile = RELAY_PROFILES.get(domain, RELAY_PROFILES.get(domain.lstrip("www."), {}))
